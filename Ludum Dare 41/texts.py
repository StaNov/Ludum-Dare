...
step_texts = [
    ...
    "Right foot.",
    "Left foot.",
    "Aaaaaand… another left foot! Because of all the joy of walking, you jumped to the air!\n\nWeee!",
    "Fun fact: There is an event in Brno where people walk around the city. One hundred kilometers during 24 hours.",
    "Yea, I mentioned it because I live in Brno.",
    "Brno is the greatest city in Czechia.",
    "...",
    "Well, it’s not, but people from Prague are angry when we say it to foreigners who don’t already know.",
    "Ha ha.",
    ...
    "…",
    "So!",
    "You slowly progress to the pond. But you don’t even mind that the journey is so long because you are so entertained by the narrative!",
    "Did I mention the weather? It’s really beautiful. Sunny and warm.",
    "The grass around you is completely fresh. As you can see.",
    "Well, you could see it if this wasn’t a text game. Just pretend then.",
    "Left foot.",
    "Right foot.",
    "A little tip: You can read the text in Morgan Freeman’s voice for better mood.",
    "Please do so and add me some points in the mood category later, otherwise it is your fault that you didn’t, so don’t blame me. Thanks.",
